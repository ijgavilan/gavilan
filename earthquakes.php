...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php $cl++ ;?>
    <li <?php if ($json_data['features'][$n]['properties']['mag'] >= 6.5){?> style="color:RGB(224, 21, 36);"
       <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 6){ ?> style="color:RGB(149, 83, 84);" <?php }
       <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5.5){ ?> style="color:RGB(149, 70, 70);" <?php }
       <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5){ ?> style="color:RGB(149, 60, 60);" <?php }
       <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 4.5){ ?> style="color:RGB(149, 50, 50);" <?php }
        <?php }else{ ?> style="color:RGB(100, 100, 100);" <?php };?>>
    ...
    <?php echo ($date_local.' hora local');?> &bull; M <?php echo ($json_data['features'][$n]['properties']['mag']);?> &bull;
    <?php $solociudad = substr($json_data['features'][$n]['properties']['place'],strpos($json_data['features'][$n]['properties']['place'], "f") + 1); echo $solociudad;?> &bull; <a href="earthquake-details.php?url=<?php echo ($json_data['features'][$n]['properties']['detail']);?>">Más detalles</a>.
    </li>
    <?php } ;?>
    <?php } ;?>
    </ol>
