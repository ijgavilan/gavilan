...
<h1><?php echo $json_data ['id'];?> </h1>
  <h2>Temperatura: <?php echo round($json_data ['data']['sensors']['3']['value'],3);?>°C </h2>
  <h2>Humedad: <?php echo round($json_data ['data']['sensors']['2']['value'],3);?>% </h2>
  <h2>Ruido: <?php echo round($json_data ['data']['sensors']['7']['value'],3);?>db </h2>
